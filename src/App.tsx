...
const NavBar = () => {
  ...
  return (
    <nav className="fixed w-full z-50 bg-gray-850/95 backdrop-blur-sm will-change-transform" role="navigation" aria-label="Main navigation">
...
const ServiceCard = ({ icon: Icon, title, description }: { icon: any; title: string; description: string }) => (
  <div className="bg-gray-850/50 backdrop-blur-sm p-6 rounded-xl hover:bg-gray-850/70 transition-smooth duration-400 will-change-transform hover:scale-105">
...
const ProjectCard = ({ image, title, description }: { image: string; title: string; description: string }) => (
  <div className="group relative overflow-hidden rounded-xl will-change-transform">
    <img 
      src={image} 
      alt={title} 
...
const PricingCard = ({ tier, price, features, onSelect }: { tier: string; price: string; features: string[]; onSelect: () => void }) => (
  <div className="bg-gray-850/50 backdrop-blur-sm p-8 rounded-xl hover:bg-gray-850/70 transition-smooth duration-400 will-change-transform hover:scale-105">
    ...
    <button 
      onClick={onSelect}
      className="w-full bg-primary hover:bg-primary-600 text-white py-3 px-4 rounded-lg transition-smooth duration-300"
...
const HomePage = () => {
  ...
  return (
    <div className="relative z-10">
      ...
      {/* Hero Section */}
      <section id="home" className="min-h-screen flex items-center justify-center" role="banner">
      ...
      {/* Services Section */}
      <section id="services" className="py-20 px-4 bg-gray-850/40 backdrop-blur-sm" role="region" aria-labelledby="services-title">
      ...
      {/* Portfolio Section */}
      <section id="portfolio" className="py-20 px-4 bg-gray-850/40 backdrop-blur-sm" role="region" aria-labelledby="portfolio-title">
        <div className="max-w-7xl mx-auto">
          <h2 id="portfolio-title" className="text-4xl md:text-5xl font-bold text-center mb-16 text-high-contrast">Nasze Realizacje</h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <ProjectCard
      ...
      {/* About Section */}
      <section id="about" className="py-20 px-4 bg-gray-850/40 backdrop-blur-sm" role="region" aria-labelledby="about-title">
        <div className="max-w-7xl mx-auto">
      ...
      {/* Pricing Section */}
      <section id="pricing" className="py-20 px-4 bg-gray-850/40 backdrop-blur-sm" role="region" aria-labelledby="pricing-title">
        <div className="max-w-7xl mx-auto">
          <h2 id="pricing-title" className="text-4xl md:text-5xl font-bold text-center mb-16 text-high-contrast">Cennik</h2>
      ...
      {/* Contact Section */}
      <section id="contact" className="py-20 px-4 bg-gray-850/40 backdrop-blur-sm" role="region" aria-labelledby="contact-title">
        <div className="max-w-3xl mx-auto">
          <h2 id="contact-title" className="text-4xl md:text-5xl font-bold text-center mb-16 text-high-contrast">Kontakt</h2>
...
function App() {
  useEffect(() => {
    if (window.location.pathname === '/') {
      ...
      splineViewer.setAttribute('url', 'https://prod.spline.design/yJ3Dbt8Ddsrf5G9E/scene.splinecode');
      document.body.insertBefore(splineViewer, document.body.firstChild);
    }
